...
%% Load relevant files
load([trainingDir filesep 'augCostTuningADA']);            %"result"
...
%% train the model
model = fitADABoost(features, labels, hyperparams);

mkdir([trainingDir filesep 'models']);
save([trainingDir filesep 'models' filesep 'ADABoost.mat'] ,"model")
