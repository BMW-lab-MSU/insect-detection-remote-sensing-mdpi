...
%       'RowMeanMinusImageMean'     - The mean of the obvservation minus the %                                     mean of the entire image.
%       'StdDev'                    - The standard deviation of each row.
%       'MaxDiff'                   - The maximum absolute first difference in
%                                     a row.
%
...
%
%   The extracted features from the continuous wavelet trasnform are:
%       'WaveletMaxRowAvg'          - The max average value of all frequency 
%                                     bins.
%       'WaveletMaxRowStd'          - The max standard deviation of all 
%                                     frequency bins.
%       'WaveletAvg'                - The average of the entire scalogram.
%       'WaveletAvgRowSkewness'     - The average skewness of all frequency 
%                                     bins.
