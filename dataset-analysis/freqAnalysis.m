...
load("../../data/training/trainingDataFiltered.mat","trainingData","trainingRowLabels","trainingMetadata");
%%
trainingDataBeeFrequencies = cell(1,length(trainingData));
harmonicRowCount = {};
harmonicRowCounter = 1;

for imageNum = 1:length(trainingData)-1
    ...
    for rowNum = 1:length(beeRows)
        ...
        harmonicRowCount{harmonicRowCounter} = harmonic;
        harmonicRowCounter = harmonicRowCounter+1;
...
%%
load("../../data/testing/testingDataFiltered.mat","testingData","testingRowLabels","testingMetadata");
%%
testingDataBeeFrequencies = cell(1,length(testingData));

for imageNum = 1:length(testingData)-1
...
%%
save("harmonicRowCount.mat","harmonicRowCount","-v7.3");