...
save(changepointResultsDir + filesep + "colResultsFiltered_gfpop.mat","results",'-v7.3');

runtime = toc;
save(changepointResultsDir + filesep + "runtimes" + filesep + "colFilteredRuntime_gfpop.mat","runtime")